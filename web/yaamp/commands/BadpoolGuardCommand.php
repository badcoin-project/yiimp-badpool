...
class BadpoolGuardCommand extends CConsoleCommand
{
	...
	private function walletProofCloseoutReport()
	{
		...
		$report['final_classification'] = 'wallet_proof_hold';
		...
		$report['classification'] = $report['closeout_valid'] ? 'wallet_proof_closeout_pass' : 'wallet_proof_hold';
		$report['final_classification'] = $report['closeout_valid'] ? 'PASS / WALLET-PROOF CLOSEOUT HELPER READY FOR PR APPROVAL' : 'wallet_proof_hold';
