...
class BadpoolGuardCommand extends CConsoleCommand
{
	...
	private function forwardCatchupStage1DrainBaseReport($command, $readOnly, $options)
	{
		...
		$report['db_mutations'] = false; $report['account_credit'] = false; $report['payout_rows_created'] = false; $report['wallet_sends'] = false; $report['backend_loops_run'] = false; $report['shares_deleted'] = false;
		return $report;
	}
	...
	private function forwardCatchupStage1DrainAddTotals(&$report, $batch)
	{
		...
		$report['total_projected_earnings'] += intval(arraySafeVal($batch, 'projected_earnings_rows', 0));
