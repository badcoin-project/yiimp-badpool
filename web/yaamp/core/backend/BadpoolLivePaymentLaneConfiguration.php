...
class BadpoolLivePaymentLaneRegistry
{
	...
	private static function configuredLanes()
	{
		...
		$groestl=array_merge($base,array('lane_id'=>'live-groestl-v1','coin_id'=>1269,'db_algo'=>'badcoin-groestl','operational_algo'=>'groestl','block_id_gt'=>31212,'batch_max_earnings'=>null,'maturity_max_blocks'=>10,'state_filename'=>'live-groestl-coordinator.json','lock_filename'=>'live-groestl-coordinator.lock','wallet_binding_identity'=>'groestl','wallet_source_account'=>'pool-groestl','accounting_enabled'=>true,'maturity_enabled'=>true,'payout_preparation_enabled'=>false,'wallet_send_enabled'=>false));
		$disabled=array(
