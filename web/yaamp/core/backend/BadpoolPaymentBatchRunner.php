...
class BadpoolPaymentBatchRunner
{
	...
	public function run($options)
	{
		...
		if ($resume) {
			...
			$ledger = array('batch_id'=>$id, 'created_at'=>$now, 'updated_at'=>$now, 'command'=>'batch-run',
				...
				'selected_account_ids'=>array(), 'created_payout_ids'=>array(), 'selected_work_by_coin'=>array(), 'approval_package_paths'=>array(),
	...
	{
		foreach (array('selected_coin_scope','selected_earning_ids','selected_block_ids','selected_account_ids','created_payout_ids','selected_work_by_coin') as $key)
