...
$src=file_get_contents(dirname(__FILE__).'/../web/yaamp/core/backend/BadpoolLiveBlockAccounting.php');$insert=file_get_contents(dirname(__FILE__).'/../stratum/share.cpp');
